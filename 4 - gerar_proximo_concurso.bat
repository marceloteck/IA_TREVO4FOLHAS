...
python "START\gerar_proximo_concurso.py" --size 15 --qtd 3 --second-size 18 --second-qtd 2 --perfil %PERFIL% --janela %JANELA% --per-brain %PER_BRAIN% --top-n %TOP_N% --max-sim %MAX_SIM% --salvar-db
